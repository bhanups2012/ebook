...
<h3 align="center">Ebook</h3>
	<div class="container">
	<form:form action="userUpdate" styleId="struct-form"
		modelAttribute="userModel">
		<table class="table table-bordered">
			<tr>
				<td><label>First Name : </label><form:input path="firstName"/></td>
				<td><label>Last Name : </label><form:input path="lastName"/></td>
				<td><label>Email Address : </label><form:input path="emailAddress"/></td>
				<td><form:button value="update" class="btn-primary">Update</form:button></td>
			</tr>
			</table>
			<table class="table table-bordered">
			<tr>
